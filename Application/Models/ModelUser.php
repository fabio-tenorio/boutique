...
class ModelUser extends Model {
    ...
    {
        $stmt = $this->connect_db()->prepare("SELECT id, id_droit, login, motpasse, prenom, nom, mail, telephone, datenaissance FROM `utilisateurs` WHERE login=:login OR mail=:mail");
