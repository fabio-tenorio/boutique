...
<div id="main_inscription">
    ...
    <form id="form_inscription" action="http://<?php echo PATH; ?>/ControllerUser/inscription" method="POST">
        ...
        <div id='champsinscription'class="form">
            <div class="form-group row d-flex flex-column justify-content-between">
            ...
            <div class="form-group row d-flex flex-column justify-content-between">
                ...
                <input type="date" placeholder="date de naissance" name="dateanniversaire" id="dateanniversaire">
            </div>
        </div>
        <div class="d-flex flex-row justify-content-between">
            <input class="mr-4" type="checkbox" id="subscribeRGPD" name="subscribeRGPD" value="RGPD">
            <label for="subscribeRGPG">Je confirme avoir pris connaissance des &nbsp<a href="http://<?php echo PATH;?>/ControllerUser/rgpd">Mentions Légales</a>.</label>
        </div>
